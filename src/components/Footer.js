...
import { Github, Linkedin, Twitter, Camera, Mail, ArrowUpRight } from "lucide-react";
...
const SOCIALS = [
  ...
  { icon: Camera,   href:"https://instagram.com/yourusername",  label:"Instagram" },
];
      ...
      <div style={{ borderTop:"1px solid rgba(255,255,255,0.05)" }}>
        <div className="container-max" style={{
          ...
          <p style={{ fontSize:11, color:"rgba(255,255,255,0.2)" }}>
            © {new Date().getFullYear()} StartlyHub by Sudhan M. All rights reserved.
          </p>
