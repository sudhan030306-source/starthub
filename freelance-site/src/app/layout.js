...
export const metadata = {
  ...
  description: "I build clean, modern, and affordable websites for small businesses, local shops, startups, and freelancers.",
  keywords: "affordable websites, freelance web developer, small business website, Sudhan M, India",
  metadataBase: new URL("https://stratlyhub.vercel.app"),
  openGraph: {
...
export default function RootLayout({ children }) {
  return (
    <html lang="en" className="scroll-smooth">
      ...
      <body className="font-body bg-ink text-snow antialiased">
        {children}
      </body>
    </html>
  );
